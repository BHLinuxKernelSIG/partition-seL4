...
assert_size_correct(seL4_IA32_VCPU, 4);
assert_size_correct(seL4_IA32_EPTPageDirectoryPointerTable, 4);
assert_size_correct(seL4_IA32_EPTPageDirectory, 4);
assert_size_correct(seL4_IA32_EPTPageTable, 4);
assert_size_correct(seL4_IA32_IPI, 4);
...
struct seL4_IA32_VCPU_ReadVMCS {
	int error;
	seL4_Uint32 value;
};
typedef struct seL4_IA32_VCPU_ReadVMCS seL4_IA32_VCPU_ReadVMCS_t;

struct seL4_IA32_VCPU_WriteVMCS {
	int error;
	seL4_Uint32 written;
};
typedef struct seL4_IA32_VCPU_WriteVMCS seL4_IA32_VCPU_WriteVMCS_t;

/*
 * Generated stubs.
 */
static inline int
seL4_IA32_PageDirectory_Map(seL4_IA32_PageDirectory service, seL4_IA32_PageDirectory pdpt, seL4_Word vaddr, seL4_IA32_VMAttributes attr)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32PageDirectoryMap, 0, 1, 2);
...
static inline int
seL4_IA32_PageDirectory_Unmap(seL4_IA32_PageDirectory service)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32PageDirectoryUnmap, 0, 0, 0);
	seL4_MessageInfo_t output_tag;
...
static inline int
seL4_IA32_IOPageTable_Unmap(seL4_IA32_IOPageTable service)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32IOPageTableUnmap, 0, 0, 0);
	seL4_MessageInfo_t output_tag;
...
seL4_IA32_IOPort_In8(seL4_IA32_IOPort service, seL4_Uint16 port)
{
...
seL4_IA32_IOPort_In16(seL4_IA32_IOPort service, seL4_Uint16 port)
{
...
seL4_IA32_IOPort_In32(seL4_IA32_IOPort service, seL4_Uint16 port)
{
...
static inline int
seL4_IA32_IOPort_Out8(seL4_IA32_IOPort service, seL4_Uint16 port, seL4_Uint8 data)
{
...
static inline int
seL4_IA32_IOPort_Out16(seL4_IA32_IOPort service, seL4_Uint16 port, seL4_Uint16 data)
{
...
static inline int
seL4_IA32_IOPort_Out32(seL4_IA32_IOPort service, seL4_Uint16 port, seL4_Uint32 data)
{
...
static inline int
seL4_IA32_VCPU_SetTCB(seL4_IA32_VCPU service, seL4_CNode tcb)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32VCPUSetTCB, 0, 1, 0);
	seL4_MessageInfo_t output_tag;
...
seL4_IA32_VCPU_ReadVMCS(seL4_IA32_VCPU service, seL4_Uint32 field)
{
	seL4_IA32_VCPU_ReadVMCS_t result;
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32VCPUReadVMCS, 0, 0, 1);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;
...
seL4_IA32_VCPU_WriteVMCS(seL4_IA32_VCPU service, seL4_Uint32 field, seL4_Uint32 value)
{
	seL4_IA32_VCPU_WriteVMCS_t result;
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32VCPUWriteVMCS, 0, 0, 2);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;
	seL4_Word mr1;
...
static inline int
seL4_IA32_VCPU_SetIOPort(seL4_IA32_VCPU service, seL4_CNode ioPort)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32VCPUSetIOPort, 0, 1, 0);
	seL4_MessageInfo_t output_tag;
...
static inline int
seL4_IA32_VCPU_SetIOPortMask(seL4_IA32_VCPU service, seL4_Uint32 low, seL4_Uint32 high, seL4_Uint32 mask)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32VCPUSetIOPortMask, 0, 0, 3);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;
	seL4_Word mr1;
...
static inline int
seL4_IA32_VCPU_WriteRegisters(seL4_IA32_VCPU service, seL4_VCPUContext *regs)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32VCPUWriteRegisters, 0, 0, 7);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;
	seL4_Word mr1;
...
static inline int
seL4_IA32_EPTPageDirectory_Map(seL4_IA32_EPTPageDirectory service, seL4_IA32_EPTPageDirectoryPointerTable pdpt, seL4_Word vaddr, seL4_IA32_VMAttributes attr)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32EPTPageDirectoryMap, 0, 1, 2);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;
	seL4_Word mr1;
...
static inline int
seL4_IA32_EPTPageDirectory_Unmap(seL4_IA32_EPTPageDirectory service)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32EPTPageDirectoryUnmap, 0, 0, 0);
	seL4_MessageInfo_t output_tag;
...
static inline int
seL4_IA32_EPTPageTable_Map(seL4_IA32_EPTPageTable service, seL4_IA32_EPTPageDirectoryPointerTable pdpt, seL4_Word vaddr, seL4_IA32_VMAttributes attr)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32EPTPageTableMap, 0, 1, 2);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;
	seL4_Word mr1;
...
static inline int
seL4_IA32_EPTPageTable_Unmap(seL4_IA32_EPTPageTable service)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32EPTPageTableUnmap, 0, 0, 0);
	seL4_MessageInfo_t output_tag;
...
static inline int
seL4_IA32_IPI_Send(seL4_IA32_IPI service, seL4_Uint8 node_id, seL4_Uint8 irq)
{
	seL4_MessageInfo_t tag = seL4_MessageInfo_new(IA32IPISend, 0, 0, 1);
	seL4_MessageInfo_t output_tag;
	seL4_Word mr0;

	/* Marshal input parameters. */
	mr0 = (node_id & 0xff) | ((irq & 0xff) << 8);
...
seL4_Untyped_RetypeAtOffset(seL4_Untyped service, int type, int offset, int size_bits, seL4_CNode root, int node_index, int node_depth, int node_offset, int num_objects)
{
	...
	mr0 = type;
	mr1 = offset;
	seL4_SetMR(2, size_bits);
	seL4_SetMR(3, node_index);
