...
epitcr_set_clksrc(epitcr_t epitcr, uint32_t v) {
    /* fail if user has passed bits that we will override */
    if(!(((~0x3000000 >> 24) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0))) _assert_fail("((~0x3000000 >> 24) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0)", "./plat/machine/hardware_gen.h", 16, __FUNCTION__);
    epitcr.words[0] &= ~0x3000000ul;
    epitcr.words[0] |= (v << 24) & 0x3000000ul;
    return epitcr;
}
...
epitcr_set_iovw(epitcr_t epitcr, uint32_t v) {
    /* fail if user has passed bits that we will override */
    if(!(((~0x20000 >> 17) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0))) _assert_fail("((~0x20000 >> 17) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0)", "./plat/machine/hardware_gen.h", 25, __FUNCTION__);
    epitcr.words[0] &= ~0x20000ul;
    epitcr.words[0] |= (v << 17) & 0x20000ul;
    return epitcr;
}
...
epitcr_set_rld(epitcr_t epitcr, uint32_t v) {
    /* fail if user has passed bits that we will override */
    if(!(((~0x8 >> 3) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0))) _assert_fail("((~0x8 >> 3) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0)", "./plat/machine/hardware_gen.h", 34, __FUNCTION__);
    epitcr.words[0] &= ~0x8ul;
    epitcr.words[0] |= (v << 3) & 0x8ul;
    return epitcr;
}
...
epitcr_set_ocien(epitcr_t epitcr, uint32_t v) {
    /* fail if user has passed bits that we will override */
    if(!(((~0x4 >> 2) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0))) _assert_fail("((~0x4 >> 2) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0)", "./plat/machine/hardware_gen.h", 43, __FUNCTION__);
    epitcr.words[0] &= ~0x4ul;
    epitcr.words[0] |= (v << 2) & 0x4ul;
    return epitcr;
}
...
epitcr_set_enmod(epitcr_t epitcr, uint32_t v) {
    /* fail if user has passed bits that we will override */
    if(!(((~0x2 >> 1) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0))) _assert_fail("((~0x2 >> 1) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0)", "./plat/machine/hardware_gen.h", 52, __FUNCTION__);
    epitcr.words[0] &= ~0x2ul;
    epitcr.words[0] |= (v << 1) & 0x2ul;
    return epitcr;
}
...
epitcr_set_en(epitcr_t epitcr, uint32_t v) {
    /* fail if user has passed bits that we will override */
    if(!(((~0x1 >> 0) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0))) _assert_fail("((~0x1 >> 0) & v) == ((0 && (v & (1ul << (31)))) ? 0x0 : 0)", "./plat/machine/hardware_gen.h", 61, __FUNCTION__);
    epitcr.words[0] &= ~0x1ul;
...
handleUnknownSyscall(word_t w)
{
    ...
    if (w == SysDebugNameThread) {
        ...
        if (cap_type != cap_thread_cap) {
            do { kprintf("\033[0m" "\033[30;1m" "<<" "\033[0m" "\033[32m" "seL4" "\033[0m" "\033[30;1m" " [%s/%d T%x \"%s\" @%x]: ", __func__, 93, (int)ksCurThread, ksCurThread->tcbName, (int)getRestartPC(ksCurThread)); kprintf("SysDebugNameThread: cap is not a TCB, halting"); kprintf(">>" "\033[0m" "\n"); } while (0);
            halt();
        }
        /* Add 1 to the IPC buffer to skip the message info word */
        name = (const char*)(lookupIPCBuffer(true, ksCurThread) + 1);
        if (!name) {
            do { kprintf("\033[0m" "\033[30;1m" "<<" "\033[0m" "\033[32m" "seL4" "\033[0m" "\033[30;1m" " [%s/%d T%x \"%s\" @%x]: ", __func__, 99, (int)ksCurThread, ksCurThread->tcbName, (int)getRestartPC(ksCurThread)); kprintf("SysDebugNameThread: Failed to lookup IPC buffer, halting"); kprintf(">>" "\033[0m" "\n"); } while (0);
            halt();
        }
        /* ensure the name isn't too long */
        if (name[strnlen(name, seL4_MsgMaxLength * sizeof(word_t))] != '\0') {
            do { kprintf("\033[0m" "\033[30;1m" "<<" "\033[0m" "\033[32m" "seL4" "\033[0m" "\033[30;1m" " [%s/%d T%x \"%s\" @%x]: ", __func__, 104, (int)ksCurThread, ksCurThread->tcbName, (int)getRestartPC(ksCurThread)); kprintf("SysDebugNameThread: Name too long, halting"); kprintf(">>" "\033[0m" "\n"); } while (0);
            halt();
        }
...
handleInvocation(bool_t isCall, bool_t isBlocking)
{
    ...
    if (__builtin_expect(!!(lu_ret.status != EXCEPTION_NONE), 0)) {
        do { kprintf("\033[0m" "\033[30;1m" "<<" "\033[0m" "\033[32m" "seL4" "\033[0m" "\033[30;1m" " [%s/%d T%x \"%s\" @%x]: ", __func__, 226, (int)ksCurThread, ksCurThread->tcbName, (int)getRestartPC(ksCurThread)); kprintf("Invocation of invalid cap #%d.", (int)cptr); kprintf(">>" "\033[0m" "\n"); } while (0);
    ...
    if (__builtin_expect(!!(status != EXCEPTION_NONE), 0)) {
        do { kprintf("\033[0m" "\033[30;1m" "<<" "\033[0m" "\033[32m" "seL4" "\033[0m" "\033[30;1m" " [%s/%d T%x \"%s\" @%x]: ", __func__, 241, (int)ksCurThread, ksCurThread->tcbName, (int)getRestartPC(ksCurThread)); kprintf("Lookup of extra caps failed."); kprintf(">>" "\033[0m" "\n"); } while (0);
        if (isBlocking) {
            handleFault(thread);
        }
        return EXCEPTION_NONE;
...
handleReply(void)
{
    ...
    case cap_null_cap:
        do { kprintf("\033[0m" "\033[30;1m" "<<" "\033[0m" "\033[32m" "seL4" "\033[0m" "\033[30;1m" " [%s/%d T%x \"%s\" @%x]: ", __func__, 305, (int)ksCurThread, ksCurThread->tcbName, (int)getRestartPC(ksCurThread)); kprintf("Attempted reply operation when no reply cap present."); kprintf(">>" "\033[0m" "\n"); } while (0);
        return;
...
init_freemem(region_t ui_reg)
{
    ...
    for (i = 0; i < get_num_avail_p_regs(); i++) {
         ...
         */
        if (pptr_to_paddr((void*)cur_reg.end) > (0xfff00000 - (0xf0000000 - 0x80000000))) {
            cur_reg.end = 0xfff00000;
        }
        if (pptr_to_paddr((void*)cur_reg.start) > (0xfff00000 - (0xf0000000 - 0x80000000))) {
...
unmapAllPageTables(pde_t *pd)
{
    ...
    for (i = 0; i < 0xf0000000 >> ARMSectionBits;) {
