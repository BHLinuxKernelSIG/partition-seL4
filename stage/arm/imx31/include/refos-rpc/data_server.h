...
void server_get_shared_dspace(void *rpc_userptr);
void reply_get_shared_dspace(void *rpc_userptr, seL4_CPtr rpc___ret__);
extern seL4_CPtr get_shared_dspace_handler(void *rpc_userptr) __attribute__((weak));
